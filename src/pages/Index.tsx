...
const Index = () => {
    ...
    useEffect(() => {
        const handleAdminModeChange = () => {
            // This would typically come from the Navigation component
            // For now, we'll check if the URL contains admin parameters
        ...
        window.addEventListener('popstate', handleAdminModeChange);

        return () => {
            window.removeEventListener('popstate', handleAdminModeChange);
        };
    }, []);
        ...
        <div className="min-h-screen bg-background">
            ...
            {isAdmin ? (
                ...
                <>
                    ...
                    <RoomsSection />
                    <AmenitiesSection />
                    {/* We'll only show a preview of contact section on homepage */}
